...
export const POSITIONS: Position[] = [
  { symbol: 'YPF',    name: 'YPF ADR',         type: 'stock', quantity: 850,  avgCost: 15.42, currentPrice: 18.72, value: 15_912,  pnl:  2_805, pnlPct: 21.4,  allocation: 28.5, color: '#1D9BF0' },
  { symbol: 'BMA',    name: 'Macro ADR',        type: 'stock', quantity: 120,  avgCost: 68.10, currentPrice: 72.45, value:  8_694,  pnl:    522, pnlPct:  6.4,  allocation: 15.6, color: '#1D9BF0' },
  ...
  { symbol: 'TGS',    name: 'TGS ADR',          type: 'stock', quantity: 300,  avgCost: 19.80, currentPrice: 22.90, value:  6_870,  pnl:    930, pnlPct: 15.7,  allocation: 12.3, color: '#1D9BF0' },
  ...
  { symbol: 'CASH',   name: 'Efectivo USD',      type: 'cash',  quantity: 2_350, avgCost: 1,   currentPrice: 1,    value:  2_350,  pnl:      0, pnlPct:  0,    allocation:  4.2, color: '#71767B' },
]
