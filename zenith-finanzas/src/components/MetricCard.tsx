...
const ACCENT_COLORS: Record<string, string> = {
  green:  'text-[#10b981] bg-[#064e3b]/40 border-[#10b981]/20',
  red:    'text-[#ef4444] bg-[#450a0a]/40 border-[#ef4444]/20',
  indigo: 'text-[#6366f1] bg-[#1e1b4b]/40 border-[#6366f1]/20',
  amber:  'text-[#f59e0b] bg-[#78350f]/40 border-[#f59e0b]/20',
  sky:    'text-[#0ea5e9] bg-[#0c4a6e]/40 border-[#0ea5e9]/20',
}
...
export default function MetricCard({ label, value, change, changePositive, icon, accent = 'green', size = 'md' }: Props) {
  ...
  return (
    <div className="bg-[#111827] border border-[#1e293b] rounded-xl p-4 flex flex-col gap-3">
      ...
      <div className="flex items-end gap-2">
        <span className={`font-mono font-bold ${size === 'md' ? 'text-2xl' : 'text-lg'} text-[#f8fafc]`}>
          {value}
        </span>
        {change !== undefined && (
