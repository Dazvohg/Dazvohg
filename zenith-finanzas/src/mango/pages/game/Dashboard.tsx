...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-4">
      ...
      {ownedCompany && (
        <Link to="/app/mango/game/empresa" className="block card border-mango-700/40 bg-mango-900/10 hover:bg-mango-900/20 transition-colors">
      ...
      {!ownedCompany && (
        <Link to="/app/mango/game/empresa" className="block card border-dashed border-gray-700 hover:border-mango-600 transition-colors text-center py-4">
      ...
      {/* Quick actions */}
      <div className="grid grid-cols-2 gap-3">
        <Link to="/app/mango/game/market"     className="btn-primary text-center text-sm">🛒 Mercado</Link>
        <Link to="/app/mango/game/objectives" className="btn-secondary text-center text-sm">🎯 Objetivos</Link>
      </div>
      <div className="grid grid-cols-2 gap-3">
        <Link to="/app/mango/game/mapa"       className="btn-secondary text-center text-sm flex items-center justify-center gap-1"><MapPin size={14} /> Mapa</Link>
        <Link to="/app/mango/game/leaderboard" className="btn-secondary text-center text-sm">🏆 Ranking</Link>
      </div>

      {/* Academia promo card */}
      <Link
        to="/app/mango/game/academia"
      ...
      {ownedAssets.length > 0 && (
        <div className="card">
          ...
          {ownedAssets.length > 5 && (
            <Link to="/app/mango/game/portfolio" className="block text-center text-xs text-argentina-blue mt-3 hover:opacity-80">
