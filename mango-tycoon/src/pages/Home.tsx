    ...
    <div className="min-h-screen bg-gray-950 overflow-x-hidden">
      ...
      <section className="px-4 py-14">
        ...
        >
          ...
          {user ? (
            <Link to="/game/academia" className="btn-primary w-full text-sm rounded-xl py-3 block text-center">
              📚 Ir a la Academia
            </Link>
          ) : (
            <Link to="/login" className="btn-primary w-full text-sm rounded-xl py-3 block text-center">
              🚀 Empezar a aprender
            </Link>
          )}
        </motion.div>
      ...
      <section className="px-4 py-20 text-center">
        ...
        >
          ...
          {user ? (
            <Link to="/game" className="btn-primary py-4 text-xl font-black rounded-2xl block text-center shadow-xl shadow-mango-500/25">
              🎮 Entrar al juego
            </Link>
          ) : (
            <Link to="/login" className="btn-primary py-4 text-xl font-black rounded-2xl block text-center shadow-xl shadow-mango-500/25">
              🚀 Empezar gratis
            </Link>
          )}
