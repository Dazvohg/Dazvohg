...
const state: AppState = {
  ...
  goals: [],
  tycoon: { mangoCash: 2500, ownedAssets: [], completedObjectiveIds: [], completedLessonIds: [], gameMonth: 1, gameYear: 2024, level: 1, xp: 0, currentEventId: null, eventHistory: [], achievements: [], triggeredEventIds: [] },
